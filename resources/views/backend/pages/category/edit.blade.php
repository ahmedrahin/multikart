...
@section('page-title')
    <title>Edit Category || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->site_title : 'Shop' }}</title>
@endsection
            ...
            <div class="col-12 d-flex">
                ...
                <div class="card-body">
                    ...
                    <div class=" mb-3 border p-3 radius-10">
                        ...
                        <form action="{{ route('update-category', $editData->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8 col-md-8">
                                                ...
                                                @if( !is_null($editData->image) )
                                                    <div class="img-box">
                                                        <div class="has-img">
                                                            <img src="{{ asset('uploads/categories/' . $editData->image) }}" alt="" id="upImg" >
                        ...
                        @if( !is_null($editData->image) )
                            <form action="{{ route('remove-category-image', ['id' => $editData->id]) }}" method="POST" name="remove-img" class="remove-img" id="removeImg">
                                @csrf
                                @method('PATCH')
...
@section('page-script')
	...
	<script>
        ...
        btnRemove.addEventListener('click', function(){
            ...
            if(removeImage){
                img.src = "{{ asset('uploads/categories/' . $editData->image) }}";
                removeImage.style.zIndex = "1";
            }
        })
	</script>
