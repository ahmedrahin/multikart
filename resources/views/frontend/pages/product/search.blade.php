...
@section('page-title')
<title>Search Products || Multikart</title>
@endsection
...
<div class="breadcrumb-section">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="page-title searchPage">
                    <h2><span>Showing results for </span>{{ $searchTerm }}</h2>
                    <label>{{ $products->count() }} results found.</label>
                </div>
            </div>
            <div class="col-sm-6">
                                                    ...
                                                    <div class="product-page-per-view">
                                                        <form action="{{ route('search-product') }}" method="GET">
                                                            ...
                                                            <select name="perPage" id="perPage" onchange="this.form.submit()">
                                                                <option value="20" {{ request('perPage') == 20 ? 'selected' : '' }}>20 Products Per Page</option>
                                                                <option value="50" {{ request('perPage') == 50 ? 'selected' : '' }}>50 Products Per Page</option>
                                                                <option value="100" {{ request('perPage') == 100 ? 'selected' : '' }}>100 Products Per Page</option>
                                                            </select>
                                                        </form>
                                                    </div>
                                        ...
                                        <div class="theme-paggination-block">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    @endphp
                                                    @if( $totalPages > 1 )
                                                        {{ $products->appends(['term' => $searchTerm])->links() }}
                                                    @else
