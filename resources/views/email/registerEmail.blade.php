      ...
      <tbody>
        ...
        <tr>
          <td class="banner">
            <table>
              <tr>
                <td colspan="2"><img style="width: 100%" src="{{ asset('frontend/images/welcome-banner.jpg') }}" alt="banner" /></td>
              </tr>
            </table>
          </td>
        </tr>
        ...
        <tr>
          <td class="section-t" style="position: relative; padding: 0 calc(15px + (88 - 15) * ((100vw - 320px) / (1920 - 320)))">
            <table style="width: 100%">
              <tr>
                <td>
                  <h1 class="heading-1" style="margin-bottom: 6px">Hi {{ $user['name'] }}, Welcome To Multikart.!</h1>
                  <p class="pera">
        ...
        <tr>
          <td class="section-t" style="padding: 0 calc(15px + (46 - 15) * ((100vw - 320px) / (1920 - 320)))">
            <p class="pera">
              If you have any question, please email us at <a href="javascript:void(0)">Multikart@example.com </a> or visit our <a href="{{ route('contactpage') }}"> Contact page.</a> You can also chat with a real
