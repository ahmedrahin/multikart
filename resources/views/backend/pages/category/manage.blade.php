...
@section('page-title')
    <title>Manage Category || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->site_title : 'Shop' }}</title>
@endsection
            ...
            <div class="col-12 d-flex">
                <div class="card radius-10 w-100">
                    <div class="card-body">
                        ...
                        <h5 class="heading">All Category List</h5>
                        </div>
                                                ...
                                                <div class="panel-heading">
                                                    <div class="row">
                                                        <div class="col-sm-12 col-xs-12">
                                                            <a href="{{ route('create-category') }}" class="btn btn-sm btn-primary pull-left"  style="margin-right:10px;"><i class="fa fa-plus-circle"></i> Add New</a>
                                                            <a href="{{ route('trash-manage-category') }}" class="btn btn-sm btn-primary pull-left"><i class="bi bi-trash-fill"></i>View Trash</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
