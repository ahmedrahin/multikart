...
@section('page-title')
    <title>All Trash Sub Category List || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->site_title : 'Shop' }}</title>
@endsection
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">All Trash Sub Category List</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-12 d-flex">
                <div class="card radius-10 w-100">
                    <div class="card-body">
                        ...
                        <h5 class="heading">All Trash Sub-category List</h5>
                        </div>
                                                ...
                                                <div class="panel-heading">
                                                    <div class="row">
                                                        <div class="col-sm-12 col-xs-12">
                                                            <a href="{{ route('manage-subCategory') }}" class="btn btn-sm btn-primary pull-left"  style="margin-right:10px;"> Go Back <i class="bx bx-right-arrow-alt"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {   
            $(function () {
                ...
                processing: false,
                serverSide: true,
                ajax: "{{ route('trash-manage-subCategory') }}",
                language: {
                    paginate: {
