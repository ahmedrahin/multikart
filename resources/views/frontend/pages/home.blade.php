...
@section('page-title')
    <title>Multikart - Multi-purpose E-commerce</title>
@endsection
...
@section('body-content')
    ...
    <!-- Home slider -->
        <section class="p-0" style="margin-top: 20px;">
            <div class="slide-1 home-slider">
                <div>
                    <div class="home text-center">
                        <img src="https://www.fashiontrends.style/wp-content/uploads/2022/05/Fashion-Trends-Vestidos-que-ayudaran-a-estilizar-tu-figura-Banner.png" alt="" class="bg-img blur-up lazyload">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                ...
                <div>
                    <div class="home text-center">
                        <img src="https://marketplace.canva.com/EAFWt8Wq208/1/0/1600w/canva-grey-minimalist-special-offer-banner-landscape-tVz4E4KVLgk.jpg" alt="" class="bg-img blur-up lazyload">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <div class="slider-contain">
    ...
    <!-- section start -->
    <section class="section-b-space addtocart_count ratio_square" style="padding-bottom: 0;">
        <div class="container">
            <div class="row g-3">
                <div class="col">
                    <div class="title4">
                    ...
                    <div class="product-5 product-m no-arrow">
                        @php
                            $products = App\Models\Product::orderBy('id', 'desc')->where('status', 1)->take(9)->get();
                        @endphp
                        @if( $products->count() != 0 )
                            @foreach( $products as $product )
                                <div class="col-md-2 col-6 col-grid-box">
                            ...
                            @endforeach 
                        @else
                            <div class="no-found">Sorry!! No Product Found</div>
                        @endif
                    </div>
                </div>
            </div>
    ...
    <section class="p-0">
        <div class="full-banner parallax text-start p-left">
            <img src="{{asset('frontend/images/pbanner.jpg')}}" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="banner-contain">
                            <h2>2023</h2>
                            <h3>clothing market</h3>
                            <h4>special offer</h4>
                        </div>
                    </div>
                </div>
    ...
    {{-- featured product start --}}
        <section class="addtocart_count ratio_square bg-title wo-bg" style="padding-bottom: 0;">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="theme-tab">
                            ...
                            <div class="tab-content-cls">
                                <div class="tab-content active default" style="display: none;">
                                    <div class="five-product no-slider row">
                                        @php
                                            $products = App\Models\Product::orderBy('id', 'desc')->where('status', 1)->whereNot('is_featured', 0)->take(10)->get();
                                        @endphp
                                        @if( $products->count() != 0 )
                                            @if($products->count() > 6)
                    ...
                    <div class="theme-tab">
                        ...
                        <div class="tab-content-cls">
                            <div id="tab-4" class="tab-content active default">
                                <div class="five-product no-slider row g-3">
                                    @php
                            ...
                            <div id="tab-5" class="tab-content">
                                <div class="five-product no-slider row g-3">
                                    @php
                                        $products = App\Models\Product::orderBy('id', 'desc')->where('status', 1)->take(12)->get();
                                    @endphp
                                    @if( $products->count() != 0 )
                                        @foreach( $products as $product )
                                            <div class="col-md-2 col-6 col-grid-box">
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('frontend/images/blog.jpg')}}"
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('frontend/images/blog2.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('frontend/images/blog3.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('frontend/images/blog4.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
