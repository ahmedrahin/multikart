...
@section('page-title')
    <title>Add New Country || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->site_title : 'Shop' }}</title>
@endsection
        ...
        <div class="row">
            <div class="col-12 d-flex">
                ...
                <div class="card-body">
                    ...
                    <h5 class="heading">Add New Country</h5>
                    </div>
                    ...
                    <div class=" mb-3 border p-3 radius-10">
                        ...
                        <form action="{{ route('store-country') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" placeholder="Enter Country Name" value="{{ old('name') }}" class="@error('name') is-invalid @enderror">                               
                                @error('name')
