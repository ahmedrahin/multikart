...
@section('page-title')
    <title>All Country List || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->site_title : 'Shop' }}</title>
@endsection
            ...
            <div class="col-12 d-flex">
                <div class="card radius-10 w-100">
                    <div class="card-body">
                        ...
                        <h5 class="heading">All Country List</h5>
                        </div>
                                                ...
                                                <table id="data_table" class="table table-striped data-table">
                                                    ...
                                                    <tbody>
                                                        @foreach( $countryList as $countries )
                                                            <!-- Modal -->
                                                            <div class="modal fade" id="country{{ $countries->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="{{ route('trash-country', $countries->id) }}" method="POST">
                                                                                @csrf
