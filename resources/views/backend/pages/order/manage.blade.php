...
@section('page-title')
    <title>All Order List || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->site_title : 'Shop' }}</title>
@endsection
        ...
        <div class="col-12 d-flex">
            <div class="card radius-10 w-100">
                <div class="card-body">
                    ...
                    <h5 class="heading">All Order List</h5>
                    </div>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{ route('del-order', $order->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
