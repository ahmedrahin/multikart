...
<!-- Mirrored from codervent.com/rukada/demo/vertical/errors-404-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Jan 2023 17:33:41 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
	...
	<title>404 || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->site_title : 'Shop' }}</title>
</head>
					...
					<div class="row g-0">
						<div class="col col-xl-5">
							<div class="card-body p-4">
								...
								<div class="mt-5"> <a href="{{url('/admin/dashboard')}}" class="btn btn-primary btn-lg px-md-5 radius-30">Go Dashboard</a>
									<a href="javascript:;" class="btn btn-outline-dark btn-lg ms-3 px-md-5 radius-30" onclick="goBack()">Back</a>
								</div>
							</div>
						</div>
						<div class="col-xl-7">
...
<!-- Mirrored from codervent.com/rukada/demo/vertical/errors-404-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Jan 2023 17:33:42 GMT -->
</html>